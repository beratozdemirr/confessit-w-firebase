...
/*
*
* bu sayfada kullanıcıdan alınan ızınle bırlıkte telefonun galerısıne erısılerek  galerıden bır resım secılmesı sağlanır
 * secılen resım bitmap formatına dönüştürülerek gerekli sıkıştırma işlemleri yapıldıktan sonra confess write activity  nın
 * activity result metoduna oluiturmuş olduğumuz bitmap formatında ki resim ve resim için olusturdugumuz resmın ısmı gönderilir
  *
