...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.ViewHolder> {
    ...
    @Override
    //confess actıvıty sınıfında tıplerı ile beraterolusturgumuz post nesnelerını adapter classımızın ıcınde kı
    //getıtemvıewtype metotu sayesınde recyc view ın position na göre tipini alıp oncreate view holder metotuna yolluyoruz
    //burda kı yolladıgımız tıpe gore oncreate vıew holder metotunun ıcınde postun kullancagı layout belırlenmektdır
    //eger tıp comment tıpınde ıse custon post comment yada tıp photo tıpınde ıse custom post kullanılacak
    ...
    //resimlerin gösterilmesinde picasso kütüphanesınden yararlandık
